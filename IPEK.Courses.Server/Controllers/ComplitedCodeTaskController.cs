...
namespace IPEK.Courses.Server.Controllers
{
    ...
    public class ComplitedCodeTaskController(IRepository<ComplitedCodeTask> repository) : BaseCrudController<ComplitedCodeTask, ComplitedCodeTaskDto>(repository)
    {
    }
}
